    ...
    items: [
      {
        ...
        a: 'Oui, vous disposez de 7 jours après réception pour retourner un article en parfait état dans son emballage d\'origine. Contactez-nous à support@ethnispirit.com pour initier un retour.',
      },
      {
