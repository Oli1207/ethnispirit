...
MODE_CATEGORIES = [
    {
        ...
        'universe': 'mode',
        'order': 1,
        'description': 'Robes wax, boubous et tenues africaines pour la femme antillaise.',
...
BIO_CATEGORIES = [
    ...
    },
    {
        ...
        'universe': 'bio',
        'order': 3,
        'description': 'Tisanes antillaises et tropicales : bien-être, détox et relaxation.',
...
MODE_PRODUCTS = [
    ...
    },
    {
        ...
        'category':      'Vêtements',
        'subcategory':   'Robes',
        'description':   'Robe cérémonie en tissu ankara aux imprimés floraux rose et dorés. Encolure dégagée, manches longues et jupe volumineuse. Une pièce habillée parfaite pour baptêmes, mariages et fêtes antillaises.',
        'origin':        "Côte d'Ivoire",
        'price':         110.00,
        'old_price':     None,
        'stock':         10,
...
BIO_PRODUCTS = [
    ...
    {
        'name':          'Tisane Hibiscus Antillais Détox',
        'category':      'Tisanes & Infusions',
        'subcategory':   'Détox',
